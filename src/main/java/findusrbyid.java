...
public class findusrbyid {
	public static void main(String[] args) {
		...
		List<User> users = template.query(qry, new Object[] { id }, new myresultsetextractors1());
		for (User u : users) {
...
class myresultsetextractors1 implements ResultSetExtractor<List<User>> {
